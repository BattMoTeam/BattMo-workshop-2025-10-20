...
* Create a new folder
* Open VS Code on the folder. In VS Code, go to the top left corner and click on `File -> Open Folder` and navigate to your created folder.
...
* Open VS Code in the project folder (if not already opened yet) and click on the Installation.ipynb file.
